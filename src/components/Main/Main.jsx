...
const Main = () => {
    ...
    const {onSent, recentPrompt, showResult, loadingState, resultData, setInput,input,loading}=useContext(Context)
    ...
    <div className="main">
        ...
        <div className="main-container">
            ...
            <>
                ...
                <div onClick={()=>onSent("Breifly summarize this concept: Urban Planning")}className="card">
